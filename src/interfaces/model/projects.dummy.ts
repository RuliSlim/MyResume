export const projectsDummy: IProject[] = [
	{
		title: "Libra19",
	...
	{
		title: "Fastpedia",
		desc: "This is mobile app that i develop using Flutter. This mobile app is for supporting each other every member youtube videos. It takes around 5 weeks to finish alone.",
		images: [
			"https://i.imgur.com/77JVJ7c.jpg",
			"https://i.imgur.com/TCLaHjG.jpg",
			"https://i.imgur.com/vZJYDjD.png",
			"https://i.imgur.com/S74Vrdd.jpg",
			"https://i.imgur.com/Rfo4tnF.png",
			"https://i.imgur.com/Ad0NgHy.jpg"
		],
		roles: [ "Mobile Engineer" ],
		stacks: [ "Dart", "Flutter", "shared_preferences", "barcode_scan", "flutter_inappwebview" ],
		video: "video"
	},
	{
		title: "VCC",
